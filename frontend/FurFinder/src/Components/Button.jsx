...
const AdoptButton = ({buttonText}) => {
  ...
  return (
    <a href="#_" alt= "Click Me" className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-indigo-500 rounded-xl group">
